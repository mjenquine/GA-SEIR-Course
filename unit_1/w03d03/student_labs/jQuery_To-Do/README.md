...
## Starter code
To get straight to jQuery, use the starter code and touch an `app.js` file to fill in the javascript.
...
1. To use the starter code, go into the `starter_code` folder (alternatively, you are welcome to start totally from scratch)
