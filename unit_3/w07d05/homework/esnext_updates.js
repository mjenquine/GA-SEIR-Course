...
// Get the min of an array of numbers, if it is negative return 'the min is negative', if its positive return 'the min is positive'. Hint: refer to the esnext notes.

let arr1 = [2, 1, 10, 6, -2, 1]
let arr2 = [1, 7, 3, 0, 14, 11]

// Write a function that logs hello world by default if there is no argument provided. Otherwise it should log the argument provided (string) ex. greetin('Brendan') => hello Brendan. Hint: refer to the esnext notes.

// Fix the for loop so that Timmy gets a golden key. Hint: refer to the esnext notes.
